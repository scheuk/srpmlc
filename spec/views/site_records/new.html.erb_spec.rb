...
describe "site_records/new" do
  before(:each) do
    assign(:site_record, stub_model(SiteRecord,
      :site => nil,
      :user => nil,
      :tc => 1,
      :nc => 1,
  ...
  it "renders new site_record form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => site_records_path, :method => "post" do
